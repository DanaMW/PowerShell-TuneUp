...
To use it place it in the desired folder.
Open BinMenu.ps1 and change the "BASE" folder at the top, then,
...
Then edit BinMenu.ps1 And recomment the BREAK that you uncommented and save.
Rerun BinMenu and there you are.. a custom menu with your current exe programs.
```
